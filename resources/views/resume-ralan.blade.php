...
<head>
    ...
    <style>
        @page {
            /* Margin bottom disesuaikan untuk memberi ruang footer yang lebih tinggi */
        ...
        footer {
            position: fixed;
            bottom: -200px;
            /* Posisi footer ditarik ke bawah */
            left: 0;
            right: 0;
            height: 200px;
        }
        ...
        .footer-text {
            ...
            font-size: 9px;
            margin-top: 15px;
            /* Memberi jarak dari logo BSrE di atasnya */
            color: #666;
            line-height: 1.3;
        }
...
<body>
    ...
    <footer>
        <table class="layout-table">
            <tr>
                <td width="55%"></td>
                <td width="45%">
                    <div style="text-align: left; font-size: 10px; margin-bottom: 4px; padding-left: 5px;">
        ...
        <img src="{{ public_path('logo/logo-bsre.png') }}" class="bsre-logo-bottom" alt="Logo BSrE">
    ...
    <main>
        ...
        <div class="section-title">Kondisi & Obat Pulang</div>
        <table>
            <tr>
                <td width="30%">Kondisi Pulang</td>
                <td>{{ $resume['kondisi_pulang'] ?: '-' }}</td>
            </tr>
            <tr>
                <td>Obat Pulang</td>
